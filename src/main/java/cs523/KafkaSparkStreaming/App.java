...
public class App 
{
    				...
    				wordCounts.foreachRDD(
        				    javaRdd -> {
        				      ...
        				      for (String key : wordCountMap.keySet()) {
        				    	  Gson g = new Gson();
        				    	  Tweeter tweet = g.fromJson(key, Tweeter.class);
    ...
    public static void init(){
    	 ...
    	 try {
    		 //this is existing table but if needed to use a new one we can use HBase create
